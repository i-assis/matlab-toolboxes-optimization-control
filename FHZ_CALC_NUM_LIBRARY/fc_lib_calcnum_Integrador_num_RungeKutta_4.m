...
%%%%%%%%%%%%% 
% version 01: 29.10.2018 -- Criação 
%   Função de integração numérica por Runge Kutta ordem 4 
% version 02: 15.05.2019 -- Correção valores conforme 
%   M. Cristina C. Cunha: Métodos Numéricos p.187 Alg 8.2, 8.3, 8.4. 
%   and 
...
%     K4 = eval(sprintf('h(i)*%s%s',f,'( x(:,i) + K3 )'));     % h(i)*f(x(:,i) + K3); 
%     === 
