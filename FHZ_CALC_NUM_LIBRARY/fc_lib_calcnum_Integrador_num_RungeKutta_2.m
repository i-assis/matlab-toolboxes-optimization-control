%% fc_lib_calcnum_Integrador_num_RungeKutta_2 
%%%%%%%%%%%%% 
% help fc_lib_calcnum_Integrador_num_RungeKutta_2 
% Belongs to private library 
%%%%%%%%%%%%% 
% Author: M.Eng. Fernando Henrique G. Zucatelli (UFABC) 
% COPYRIGHT: Free for non evil use. (Não use este código para o mal) 
%%%%%%%%%%%%% 
% fc_lib_calcnum_Integrador_num_RungeKutta_2(t,x0,f) 
% Funcao para integrador numérico por Runge Kutta ordem 2 
% t: vetor de tempo 
% x0: vetor de condições iniciais 
% f: nome da função a ser integrada 
%%%%%%%%%%%%% 
% version 01: 15.05.2019 -- Criação 
%   Função de integração numérica por Runge Kutta ordem 2. 
...
% x = fc_lib_calcnum_Integrador_num_RungeKutta_2(tsimu, x0, f); 
...
%%%%%%%%%%%%% 
%% algorithm 
function x = fc_lib_calcnum_Integrador_num_RungeKutta_2(t, x0, f) 
Nx = max(size(x0)); 
nt = size(t); 
...
%% Passo de integração de Runge-Kutta 3 
for i = 1:(max(nt)-1) 
    K1 = h(i)*F(x(:,i)); 
    K2 = h(i)*F(x(:,i) + K1); 
    % === 
