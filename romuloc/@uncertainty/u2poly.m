function dout = u2poly(din)
% UNCERTAINTY/U2POLY - Convert parallelotopic and interval blocks to polytopes
%   
%   deltapoly = u2poly ( delta )
% 
...
%   LAAS-CNRS, Toulouse, France
  ...
  for blkidx=1:din.nbb
      switch din.constr{blkidx}(1:7)
        ...
        case 'paralle'
            nbaxes=length(din.vtx{blkidx})-1;
            if nbaxes>11
                fprintf('Convertion is computing %i vertices\n',2^nbaxes);
            end
            clear vtx
